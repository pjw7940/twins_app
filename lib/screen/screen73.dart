...
class screen73 extends StatefulWidget {
  const screen73({super.key});

  @override
  State<screen73> createState() => _screen73State();
}
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Text("김용의",style: TextStyle(fontSize: 48,color: Colors.red),),
            Text("등번호: 75",style: TextStyle(fontSize: 48,color: Colors.white),),
