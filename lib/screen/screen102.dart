...
class screen102 extends StatefulWidget {
  const screen102({super.key});

  @override
  State<screen102> createState() => _screen102State();
}
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Text("강현석",style: TextStyle(fontSize: 48,color: Colors.red),),
            Text("등번호: 104",style: TextStyle(fontSize: 48,color: Colors.white),),
