...
class screen78 extends StatefulWidget {
  const screen78({super.key});

  @override
  State<screen78> createState() => _screen78State();
}
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Text("박경완",style: TextStyle(fontSize: 48,color: Colors.red),),
            Text("등번호: 80",style: TextStyle(fontSize: 48,color: Colors.white),),
