...
class screen68 extends StatefulWidget {
  const screen68({super.key});

  @override
  State<screen68> createState() => _screen68State();
}
    ...
    return Scaffold(backgroundColor: Colors.black,
      ...
      body: Center(
        child: Column(mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Text("이호준",style: TextStyle(fontSize: 48,color: Colors.red),),
            Text("등번호: 70",style: TextStyle(fontSize: 48,color: Colors.white),),
