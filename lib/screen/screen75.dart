...
class screen75 extends StatefulWidget {
  const screen75({super.key});

  @override
  State<screen75> createState() => _screen75State();
}
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Text("정주현",style: TextStyle(fontSize: 48,color: Colors.red),),
            Text("등번호: 77",style: TextStyle(fontSize: 48,color: Colors.white),),
