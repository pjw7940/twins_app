...
class screen67 extends StatefulWidget {
  const screen67({super.key});

  @override
  State<screen67> createState() => _screen67State();
}
    ...
    return Scaffold(backgroundColor: Colors.black,
      ...
      body: Center(
        child: Column(mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Text("양희준",style: TextStyle(fontSize: 48,color: Colors.red),),
            Text("등번호: 69",style: TextStyle(fontSize: 48,color: Colors.white),),
