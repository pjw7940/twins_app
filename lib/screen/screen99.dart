...
class screen99 extends StatefulWidget {
  const screen99({super.key});

  @override
  State<screen99> createState() => _screen99State();
}

class _screen99State extends State<screen99> {
  @override
        ...
        body: Center(
          child: Column(mainAxisAlignment: MainAxisAlignment.center,
            children: [
              ...
              Text("등번호: 101",style: TextStyle(fontSize: 48,color: Colors.white),),
