...
class screen112 extends StatefulWidget {
  const screen112({super.key});

  @override
  State<screen112> createState() => _screen112State();
}

class _screen112State extends State<screen112> {
  @override
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Text("한지용",style: TextStyle(fontSize: 48,color: Colors.red),),
