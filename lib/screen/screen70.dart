...
class screen70 extends StatefulWidget {
  const screen70({super.key});

  @override
  State<screen70> createState() => _screen70State();
}
    ...
    return Scaffold(backgroundColor: Colors.black,
      ...
      body: Center(
        child: Column(mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Text("서용빈",style: TextStyle(fontSize: 48,color: Colors.red),),
            Text("등번호: 72",style: TextStyle(fontSize: 48,color: Colors.white),),
