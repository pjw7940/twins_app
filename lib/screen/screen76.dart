...
class screen76 extends StatefulWidget {
  const screen76({super.key});

  @override
  State<screen76> createState() => _screen76State();
}
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Text("양영동",style: TextStyle(fontSize: 48,color: Colors.red),),
            Text("등번호: 78",style: TextStyle(fontSize: 48,color: Colors.white),),
