...
class screen74 extends StatefulWidget {
  const screen74({super.key});

  @override
  State<screen74> createState() => _screen74State();
}
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Text("윤진호",style: TextStyle(fontSize: 48,color: Colors.red),),
            Text("등번호: 76",style: TextStyle(fontSize: 48,color: Colors.white),),
