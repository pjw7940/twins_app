...
class screen69 extends StatefulWidget {
  const screen69({super.key});

  @override
  State<screen69> createState() => _screen69State();
}
    ...
    return Scaffold(backgroundColor: Colors.black,
      ...
      body: Center(
        child: Column(mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Text("김경태",style: TextStyle(fontSize: 48,color: Colors.red),),
            Text("등번호: 71",style: TextStyle(fontSize: 48,color: Colors.white),),
